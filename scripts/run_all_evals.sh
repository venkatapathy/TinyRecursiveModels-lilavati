...
./venv/bin/python evaluate.py --config-name cfg_vanilla project_name=trm-icml-eval +split=test +compile=false


echo "Running TRM Concat (OOD)..."
./venv/bin/python evaluate.py --config-name cfg_basicfour_concat project_name=trm-icml-eval +split=test +compile=false

echo "Running TRM Reverse (OOD)..."
./venv/bin/python evaluate.py --config-name cfg_basicfour_concat_reverse project_name=trm-icml-eval +split=test +compile=false
